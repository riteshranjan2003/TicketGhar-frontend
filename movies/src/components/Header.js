...
import { AppBar, Autocomplete, Tab, TextField, Toolbar, Tabs, IconButton } from '@mui/material';
            ...
            <Toolbar>
                <Box width={'20%'}>
                    <IconButton LinkComponent={Link} to="/">
                        <MovieIcon sx={{ color: '#fff', fontSize: 30 }} />
                        <p style={{ color: '#fff', fontSize: '1.5rem', marginLeft: '10px', fontWeight: 'bold' }}>TicketGhar</p>
                    </IconButton>
                </Box>
